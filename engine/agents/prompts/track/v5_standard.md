...
## 4. Granularity Discipline — Compress, Do Not Expand
...
- **Compression Rule**: If multiple items are typically taught together as part of expressing algorithms, they MUST be unified into a single higher-order concept module. Prefer a module like `computing.fundamentals.computational_expression` over three micro-modules like `variables`, `arithmetic`, `conditionals`.
